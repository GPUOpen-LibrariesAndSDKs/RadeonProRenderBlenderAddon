...
class RPRShaderNodeUber(RPRShaderNode):
    ...
    node_sockets = {
        ...
        'Reflection IOR': ('rpr_socket_ior', 1.5, pyrprx.UBER_MATERIAL_REFLECTION_IOR, "self.enable_reflection and self.reflection_mode == 'RPRX_UBER_MATERIAL_REFLECTION_MODE_PBR'"),
        'Reflection Metalness': ('rpr_socket_weight', 0.0, pyrprx.UBER_MATERIAL_REFLECTION_METALNESS, "self.enable_reflection and self.reflection_mode == 'RPRX_UBER_MATERIAL_REFLECTION_MODE_METALNESS'"),
