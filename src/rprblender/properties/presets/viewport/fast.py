...
rpr.viewport_ray_depth.max_ray_depth = 8
rpr.viewport_ray_depth.diffuse_depth = 8
rpr.viewport_ray_depth.glossy_depth = 8
rpr.viewport_ray_depth.shadow_depth = 8
rpr.viewport_ray_depth.refraction_depth = 8
rpr.viewport_ray_depth.glossy_refraction_depth = 8
