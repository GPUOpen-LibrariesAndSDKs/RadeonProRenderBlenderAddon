...
def draw_image(im):
    GL_RGBA = 0x1908
    GL_FLOAT = 0x1406
    windll.opengl32.glDrawPixels.argtypes = [
        ctypes.c_int, ctypes.c_int, ctypes.c_uint, ctypes.c_uint, ctypes.c_void_p]
    windll.opengl32.glDrawPixels(width, height, GL_RGBA, GL_FLOAT, im.ctypes.data)  
...
def test():
    ...
    def wnd_proc(hWnd, Msg, wParam, lParam):
        ...
        if win32con.WM_DESTROY == Msg:
            windll.user32.PostQuitMessage(0)
        elif win32con.WM_CREATE == Msg:
